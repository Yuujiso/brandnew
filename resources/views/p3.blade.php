    ...
    <div class="product-page">
        <div class="wrapper" data-product-wrapper="">
            <nav class="breadcrumb" role="navigation" aria-label="breadcrumbs">
                ...
                <span title="This page">Comfortable Linen</span>
            </nav>
                ...
                <div class="grid__item large--one-third" id="productInfo-product">
                    <div class="text-center">
                        <h5 class="product__price uppercase h5">
                            <span class="money"><span id="ProductPrice-product"><span class="money">$117.99</span></span></span>

                            <p class="small compare-at em" id="ComparePriceWrapper-product" style="display: none">
                                <span class="money"><span id="ComparePrice-product">$117.99</span></span>
                            </p>
                        </h5>
                        <h1 class="h2">Comfortable Linen</h1>
